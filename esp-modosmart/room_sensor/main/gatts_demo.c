...
#define GATTS_SERVICE_UUID_ENVIRONMENTAL_DATA   0xA000
#define GATTS_CHAR_UUID_TEMPERATURE             0x2A6E
#define GATTS_CHAR_UUID_HUMIDITY                0x2A6F
#define GATTS_CHAR_UUID_PRESENCE                0xA001
#define GATTS_DESCR_UUID_TEST_A                 0x3333
#define GATTS_NUM_HANDLE_TEST_A                 12

#define GATTS_SERVICE_UUID_BATTERY              0x180F
#define GATTS_SERVICE_UUID_BATTERY_LEVEL        0x2A19
#define GATTS_DESCR_UUID_TEST_B                 0x2222
#define GATTS_NUM_HANDLE_TEST_B                 4

#define GATTS_SERVICE_UUID_DEVICE_INFORMATION   0x180A
#define GATTS_SERVICE_UUID_FIRMWARE_VERSION     0x2A26
...
static uint8_t adv_service_uuid128[48] = {
    ...
    0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x00, 0xA0, 0x00, 0x00,
    ...
    //third uuid, 16bit, [12], [13], [14], [15] is the value
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[PROFILE_A_APP_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_ENVIRONMENTAL_DATA;
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        if (param->read.handle == 42) {
          // Reading temperature
          rsp.attr_value.len = 2;
          rsp.attr_value.value[0] = 0x99;
          rsp.attr_value.value[1] = 0x07;
        } else if (param->read.handle == 44) {
          // Reading humidity
          rsp.attr_value.len = 2;
          rsp.attr_value.value[0] = 0x16;
          rsp.attr_value.value[1] = 0x0E;
        } else {
          // Reading presence
          rsp.attr_value.len = 2;
          rsp.attr_value.value[0] = 0xF3;
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEMPERATURE;
        ...
        gl_profile_tab[PROFILE_A_APP_ID].service_handle = param->create.service_handle;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_HUMIDITY;
        ...
        gl_profile_tab[PROFILE_A_APP_ID].service_handle = param->create.service_handle;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_PRESENCE;
...
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[PROFILE_B_APP_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_BATTERY;
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_B_APP_ID].char_uuid.uuid.uuid16 = GATTS_SERVICE_UUID_BATTERY_LEVEL;
...
static void gatts_profile_c_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[PROFILE_C_APP_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_DEVICE_INFORMATION;
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[5] = '2';
        rsp.attr_value.value[6] = '2';
        esp_ble_gatts_send_response(gatts_if, param->read.conn_id, param->read.trans_id,
                                    ESP_GATT_OK, &rsp);
        break;
    }
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_C_APP_ID].char_uuid.uuid.uuid16 = GATTS_SERVICE_UUID_FIRMWARE_VERSION;
